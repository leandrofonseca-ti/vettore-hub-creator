    ...
    <section className="relative flex min-h-screen flex-col items-center justify-center px-6 py-24 text-center">
      ...
      <div className="relative z-10 mx-auto max-w-5xl animate-fade-in-up">
        ...
        <p className="mx-auto mb-14 max-w-2xl text-lg text-[#c8c8c8] md:text-xl">
          Estratégias práticas para construir relacionamentos com médicos e fonoaudiólogos que
          transformam conexões em crescimento sustentável.
        </p>
        ...
        <div className="mx-auto mb-16 grid max-w-2xl grid-cols-3 gap-4 md:gap-8">
          {[
            ...
            <div
              key={s.label}
              className="rounded-xl border border-gold/20 bg-white/[0.02] p-4 backdrop-blur md:p-6"
            >
              <div className="text-3xl font-bold text-gold md:text-5xl">
                <Counter end={s.n} suffix={s.suffix ?? ""} />
              </div>
              <div className="mt-2 text-xs uppercase tracking-wider text-[#c8c8c8] md:text-sm">
                {s.label}
              </div>
            </div>
          ))}
      ...
      <div className="mx-auto grid max-w-6xl gap-16 md:grid-cols-2 md:gap-20">
        ...
        <Reveal delay={150}>
          <p className="text-lg leading-relaxed text-[#c8c8c8]">
            Centros auditivos que esperam o paciente bater à porta enfrentam um teto invisível. O
            verdadeiro crescimento vem de relacionamentos estratégicos com quem, todos os dias,
          ...
          <div className="mt-8 rounded-xl border-l-4 border-gold bg-white/[0.03] p-6 italic text-white/90">
            "Você não vende aparelhos auditivos. Você devolve a capacidade de ouvir histórias,
            risadas e a vida."
          </div>
        </Reveal>
      </div>
  ...
  const items = [
    {
      icon: "🤝",
      title: "Confiança",
      text: "Pacientes seguem a indicação de quem confiam — médicos e fonoaudiólogos.",
    },
    {
      icon: "💡",
      title: "Experiência Prévia",
      text: "A jornada começa antes da loja: na consulta, no exame, na conversa.",
    },
    {
      icon: "🌐",
      title: "Relacionamento",
      text: "A rede de profissionais é o ativo mais valioso de um centro auditivo.",
    },
  ];
  return (
  ...
  const steps = [
    {
      letter: "V",
      name: "Valor",
      text: "Ofereça antes de pedir. Compartilhe conhecimento, materiais e suporte real.",
    },
    {
      letter: "A",
      name: "Autenticidade",
      text: "Seja você mesmo. Profissionais reconhecem aproximações genuínas a quilômetros.",
    },
    {
      letter: "L",
      name: "Lembrete",
      text: "Esteja presente sem ser invasivo. Toques regulares mantêm sua marca viva.",
    },
    {
      letter: "O",
      name: "Objetivo",
      text: "Tenha clareza do que cada conexão precisa para evoluir e prosperar.",
    },
    {
      letter: "R",
      name: "Reciprocidade",
      text: "Construa via mão dupla. Indique, ajude, conecte — e o ciclo retorna.",
    },
  ];
  return (
        ...
        <Reveal delay={200}>
          <div className="rounded-3xl border border-gold/30 bg-gradient-to-br from-white/[0.04] to-transparent p-10 shadow-elegant md:p-14">
            <p className="font-display text-2xl leading-relaxed text-white md:text-3xl">
              Nós somos{" "}
              <span className="border-b-2 border-dashed border-gold pb-1 text-gold">
                [especialidade]
              </span>{" "}
              para{" "}
              <span className="border-b-2 border-dashed border-gold pb-1 text-gold">[público]</span>{" "}
              e ajudamos a{" "}
              <span className="border-b-2 border-dashed border-gold pb-1 text-gold">
                [transformação]
              </span>
            ...
            <div className="mt-10 border-t border-white/10 pt-8">
              ...
              <p className="mt-3 text-lg italic text-[#c8c8c8] md:text-xl">
                "Nós somos especialistas em adaptação auditiva para adultos 60+ e ajudamos a
                recuperar a clareza nas conversas em família."
              </p>
            </div>
          </div>
        </Reveal>
  ...
  const cards = [
    {
      ...
      text: "Liste os 50 profissionais mais relevantes da sua região e classifique por potencial.",
    },
    {
      n: "02",
      title: "Conteúdo de Autoridade",
      text: "Produza materiais úteis: protocolos, casos clínicos, atualizações técnicas.",
    },
    {
      n: "03",
      title: "Eventos & Encontros",
      text: "Promova encontros mensais — café técnico, workshops e apresentações.",
    },
    {
      n: "04",
      title: "Programa de Indicação",
      text: "Crie um sistema claro de retorno e reconhecimento para quem indica.",
    },
    {
      n: "05",
      title: "Presença Digital Ativa",
      text: "Esteja onde os profissionais consomem conteúdo: LinkedIn, grupos, eventos.",
    },
  ];
  return (
    <section className="px-6 py-24 md:py-32">
          ...
          {cards.map((c, i) => (
            <Reveal key={c.n} delay={i * 80}>
              <div className="group h-full rounded-2xl border border-white/5 bg-card p-8 transition-all hover:-translate-y-1 hover:border-gold/40 hover:shadow-gold">
                <div className="font-display text-5xl font-bold text-gold/80 group-hover:text-gold">
                  {c.n}
                </div>
...
function MatrizSection() {
  const cells = [
    {
      label: "OURO",
      criteria: "Alto volume + Alto alinhamento",
      action: "Visitas mensais, conteúdo exclusivo",
      bg: "var(--gold)",
      fg: "var(--navy-deep)",
    },
    {
      label: "PRATA",
      criteria: "Volume médio + Alinhamento alto",
      action: "Toques quinzenais, eventos",
      bg: "var(--silver)",
      fg: "var(--navy-deep)",
    },
    {
      label: "BRONZE",
      criteria: "Alto volume + Alinhamento médio",
      action: "Nutrição contínua, conteúdo",
      bg: "var(--bronze)",
      fg: "#fff",
    },
    {
      label: "ESPERA",
      criteria: "Baixo volume + Baixo alinhamento",
      action: "Newsletter, monitoramento",
      bg: "oklch(0.4 0.01 250)",
      fg: "#fff",
    },
  ];
  return (
            ...
            <Reveal key={e.title} delay={i * 70}>
              <div className="h-full rounded-xl border border-white/5 bg-card p-6">
                ...
                <p className="mt-2 text-sm text-[#c8c8c8]">
                  <span className="font-semibold text-gold">Solução: </span>
                  {e.sol}
                </p>
              </div>
            </Reveal>
  ...
  const weeks = [
    {
      week: "Semana 01",
      title: "Mapeamento",
      tasks: ["Liste 50 profissionais", "Classifique por potencial", "Pesquise especialidades"],
    },
    {
      week: "Semana 02",
      title: "Aproximação",
      tasks: ["Crie kit de apresentação", "Inicie 10 primeiros contatos", "Agende 5 visitas"],
    },
    {
      week: "Semana 03",
      title: "Conteúdo",
      tasks: ["Produza 1 material técnico", "Distribua para a rede", "Convide para evento"],
    },
    {
      week: "Semana 04",
      title: "Consolidação",
      tasks: ["Realize evento/café", "Mensure resultados", "Planeje próximos 30 dias"],
    },
  ];
  return (
    <section className="bg-navy px-6 py-24 md:py-32">
  ...
  const groups = [
    {
      title: "Mapeamento",
      items: [
        "Lista de 50 profissionais",
        "Classificação por matriz",
    ...
    {
      title: "Mensuração",
      items: ["CRM de relacionamentos", "Indicadores de indicação", "Revisão trimestral"],
    },
  ];
  return (
    <section className="px-6 py-24 md:py-32">
